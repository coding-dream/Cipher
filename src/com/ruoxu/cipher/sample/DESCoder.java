 ...
 * <h1>对称加密算法DES</h1>
 * 注意，该算法后续算法替代有  3重DES算法即(DESede) AES
 * 
 */

public class DESCoder {
	private static String KEY_ALGORITHM= "DES";// 秘钥Key的生成算法,JDK仅支持56位秘钥
	/**
	 ...
	 * 注意，上面的也不能随意搭配
	 */
	private static String CIPHER_ALGORITHM= "DES/ECB/PKCS5Padding";// 加密和解密算法/工作模式/填充方式 .
	...
	public static byte[] initKey(){
		try {
			...
			generator.init(56);//JDK仅支持56位
//			generator.init(new SecureRandom());//以默认长度初始化,因为JDK仅仅支持56位，故同上
